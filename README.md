...
ProTddOracle is an automated testing system developed in PL/SQL, designed to simplify and expedite the process of creating unit tests in the PL/SQL language.
...
There is a significant difference between an adapted system and a dedicated one, and ProTddOracle is dedicated to the PL/SQL language.

Unlike other solutions that involve the use of additional programming languages, such as jUnit which uses Java, ProTddOracle allows PL/SQL developers to create tests directly, eliminating the need to learn a new language and significantly reducing the learning curve.
...
Often, PL/SQL developers and teams encounter the need to create unit tests for their Procedures, Functions, and Packages. However, most available solutions involve the use of additional programming languages, which can be complex and time-consuming. ProTddOracle aims to address this issue by allowing tests to be written directly in PL/SQL, simplifying and streamlining the process.
...
Here are the steps to get started using ProTddOracle in your project:

## Installation - User Creation

1. Download the ProTddOracle system scripts.

2. To install and use the ProTddOracle system, you need to create two users.
...
Note: The ProTddOracle system was developed using the "Oracle Database 19c Release 19.0.0.0.0" version. If you encounter any issues with earlier versions, please contact us.
...
[![ProTddOracle - Test Examples](https://img.youtube.com/vi/Ozswl1GJFdE/0.jpg)](https://www.youtube.com/watch?v=Ozswl1GJFdE "ProTddOracle - Test Examples")
